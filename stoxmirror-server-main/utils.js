...
//     to: "support@athenetrades.com ", // list of receivers
...
const sendWithdrawalEmail = async ({ to, address, amount, method, timestamp, from }) => {
  ...
  let info = await transporter.sendMail({
    ...
    <body>
        <div class="container">
         <div class="header">
            <img src="cid:logo" alt="athenetrades Logo">
...
const sendWelcomeEmail = async ({ to, token }) => {
  ...
  let info = await transporter.sendMail({
    from: `"Athenetrades Team" <${process.env.EMAIL_USER}>`, // sender address
    to: to, // recipient address
    subject: "Welcome to athenetrades!", // subject line
    html: `
      <html>
      <head>
        <style>
      ...
      <body>
        <div class="email-container">
          ...
          <div class="content">
            <h2>Welcome to athenetrades!</h2>
            <p>
              Thank you for joining athenetrades! We're excited to have you on board.
          ...
          <div class="footer">
            <p>
              If you did not sign up for athenetrades, please ignore this email or
