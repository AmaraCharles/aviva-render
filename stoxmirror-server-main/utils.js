...
//     to: "support@Syncextrade.net ", // list of receivers
...
const sendWithdrawalEmail = async ({ to, address, amount, method, timestamp, from }) => {
  ...
  let info = await transporter.sendMail({
    ...
    <body>
        <div class="container">
         <div class="header">
            <img src="cid:logo" alt="Syncextrade Logo">
...
const sendWelcomeEmail = async ({ to, token }) => {
  ...
  let info = await transporter.sendMail({
    from: `"Syncextrade Team" <${process.env.EMAIL_USER}>`, // sender address
    to: to, // recipient address
    subject: "Welcome to Syncextrade!", // subject line
    html: `
      <html>
      <head>
        <style>
      ...
      <body>
        <div class="email-container">
          ...
          <div class="content">
            <h2>Welcome to Syncextrade!</h2>
            <p>
              Thank you for joining Syncextrade! We're excited to have you on board.
          ...
          <div class="footer">
            <p>
              If you did not sign up for Syncextrade, please ignore this email or
