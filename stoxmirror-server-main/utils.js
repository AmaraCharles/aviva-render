...
//     to: "support@capitalfideltrade.com ", // list of receivers
...
const sendWithdrawalEmail = async ({ to, address, amount, method, timestamp, from }) => {
  ...
  let info = await transporter.sendMail({
    ...
    <body>
        <div class="container">
         <div class="header">
            <img src="cid:logo" alt="capitalfideltrade Logo">
            ...
            <div class="footer">
                <p>Best regards,</p>
                <p>The capitalfideltrade Team</p>
...
const sendWelcomeEmail = async ({ to, token }) => {
  ...
  let info = await transporter.sendMail({
    from: `"capitalfideltrade Team" <${process.env.EMAIL_USER}>`, // sender address
    to: to, // recipient address
    subject: "Welcome to capitalfideltrade!", // subject line
    html: `
      <html>
      <head>
        <style>
      ...
      <body>
        <div class="email-container">
          ...
          <div class="content">
            <h2>Welcome to capitalfideltrade!</h2>
            <p>
              Thank you for joining capitalfideltrade! We're excited to have you on board.
          ...
          <div class="footer">
            <p>
              If you did not sign up for capitalfideltrade, please ignore this email or
